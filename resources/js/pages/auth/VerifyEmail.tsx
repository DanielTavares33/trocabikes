  ...
  return (
    <Layout>
      ...
      <div
        ...
        className="flex min-h-screen flex-col items-center justify-center bg-bg px-6 py-12"
      >
        ...
        <div className="w-full max-w-sm rounded-sm border border-border bg-surface p-8">
          ...
          <div className="rounded-sm border border-border bg-bg-subtle p-3">
            <p className="text-sm text-text-muted">
              Click the link in the email to verify your account. If you didn't
              receive the email, we can send another one.
            </p>
          </div>
