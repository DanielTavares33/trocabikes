        ...
        <main className="flex-1 px-6 py-8 lg:px-12">
          <div className="mx-auto max-w-6xl">
            <nav className="mb-6 flex items-center gap-2 text-sm text-text-muted">
              ...
              <span>/</span>
              <span className="truncate text-text">{bike.title}</span>
            </nav>
            ...
            <div className="grid gap-8 lg:grid-cols-3">
              ...
              <div className="flex flex-col gap-6">
                <div className="rounded-sm border border-border bg-surface p-6">
                  <div className="mb-4">
                    <p
                      data-testid="bike-show-brand"
                      className="mb-1 text-xs font-medium tracking-wide text-text-subtle uppercase"
                    >
                      {bike.brand}
                    </p>
                    <h1
                      data-testid="bike-show-title"
                  ...
                  <div className="grid grid-cols-2 gap-4 border-t border-border pt-4">
                    <div>
                      ...
                      <p className="font-medium text-text">{bike.year}</p>
                    </div>
                    <div>
                      <p className="text-xs text-text-subtle">Size</p>
                      <p className="font-medium text-text">{bike.size}</p>
                    </div>
                    <div>
                      <p className="text-xs text-text-subtle">Frame</p>
                    ...
                    {bike.kilometers != null && (
                      <div>
                        <p className="text-xs text-text-subtle">Kilometers</p>
                        <p className="font-medium text-text">
